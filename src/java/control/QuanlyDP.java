 ...
 * @author nguye
 */
@WebServlet(name = "QuanlyDP", urlPatterns = {"/quanlydatphong"})
public class QuanlyDP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<enQuanlyDP> listhn = dao.getQuanlyDPHN(mks);
        
        List<enQuanlyDP> listtuan = dao.getQuanlyDPTUAN(mks);
